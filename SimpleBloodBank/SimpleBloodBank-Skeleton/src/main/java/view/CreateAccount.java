    ...
    protected void doPost( HttpServletRequest request, HttpServletResponse response )
        ...
        if( aLogic.getAccountWithUsername( username ) == null ){
            try {
                ...
                //assume this is for bloodbank
                //use blood banklogic to create entity
                //use personlogic getWithID to get the person entity form DB
                //user blodbank setter, set the person to bloodbank entity
                //add blodd bank to DB
                aLogic.add( account );
            } catch( Exception ex ) {
